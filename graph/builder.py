...
#executable_builder.invoke({"user_input": "이하랑", "subject_input": "수학", "difficulty": "매우 어려움"})
#executable_builder.invoke({"user_input": "이하랑", "subject_input": "국어", "difficulty": "매우 어려움"})
executable_builder.invoke({"user_input": "이하랑", "subject_input": "영어", "difficulty": "쉬움"})
